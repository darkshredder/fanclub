"""
Django settings for fanclubBackend project.
...
SECRET_KEY = 'z83of#f&cytl9dkuyjxepojk^j$$f-+&ejk*!l^j!w$m(@4oo@'
...
ROOT_URLCONF = 'fanclubBackend.urls'
...
WSGI_APPLICATION = 'fanclubBackend.wsgi.application'
